    ...
    <nav className="py-10">
      <Container>
        <div className="flex items-center">
          ...
          <div className="lg:w-2/12 w-6/12">
            <Link href="/">
              <a className="flex items-center justify-center lg:justify-start">
                <div className="w-10 h-10 bg-blue-500 rounded flex items-center justify-center mr-4 shadow-2xl">
                  B2
                </div>
                BlogStrap2
              </a>
          ...
          <div
            className={`lg:w-7/12 w-full bg-gradient-to-b from-blue-300 to-blue-600 lg:bg-none fixed lg:static top-0 h-full lg:h-auto p-10 lg:p-0 transition-all ${
          ...
          >
            ...
            <form onSubmit={doSearch}>
              <input
                className="bg-blue-500 py-3 px-6 w-full lg:rounded-full rounded-lg bg-search pl-12 text-white placeholder-white"
                placeholder="Search ..."
